    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-6 text-center">
                <h1 className="font-serif text-2xl font-bold text-[#f3ece4] tracking-wide">
            ...
            <form onSubmit={submit} className="space-y-4">
                <div>
                    ...
                    <TextInput
                        ...
                        name="email"
                        value={data.email}
                        className="mt-1 block w-full bg-[#26221d] border-[#4a3e30] text-[#f3ece4] placeholder-[#736859] focus:border-[#f59e0b] focus:ring-[#f59e0b] rounded-lg px-3.5 py-2.5"
